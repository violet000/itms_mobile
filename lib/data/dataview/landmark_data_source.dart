  ...
  LandmarkDataSource({
    ...
    _landmarkRows = landmarks
        .map<DataGridRow>((landmark) => DataGridRow(cells: [
              ...
              DataGridCell<String>(columnName: 'areaName', value: landmark.areaName),
              DataGridCell<int>(columnName: 'locationType', value: landmark.locationType),
    ...
    return DataGridRowAdapter(
      cells: row.getCells().map<Widget>((cell) {
        if (cell.columnName == 'locationType') {
          ...
          final idIndex = row.getCells().indexWhere((c) => c.columnName == 'id');
          if (idIndex != -1) {
