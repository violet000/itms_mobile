...
class _BarcodeScannerWidgetState extends State<BarcodeScannerWidget> {
  static const platform = MethodChannel('com.example.itms_mobile/barcode_scanner');
  static const eventChannel = EventChannel('com.example.itms_mobile/barcode_events');
